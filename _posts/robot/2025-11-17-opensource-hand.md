...
![Yale OpenHand Model O](https://www.eng.yale.edu/grablab/openhand/images/model_o_main_0.png)
...
* **링크:**
    * **[Yale GRAB Lab OpenHand 공식 페이지](https://www.eng.yale.edu/grablab/openhand/)** (수정된 링크)
    * **[OpenHand URDF/STL 미러 리포지토리 (JHU)](https://github.com/jhu-lcsr/open_hand_project_model)** (URDF 모델 파일이 포함된 안정적인 GitHub 링크)

---

## 2. InMoov Hand

![InMoov Hand](https://inmoov.fr/wp-content/uploads/2022/01/inmoov-hand-i02-vign.jpg)
...
* **링크:**
    * **[InMoov 공식 웹사이트](https://inmoov.fr/)** (현재(2025년 11월) 기준 접속 확인되나, 환경에 따라 불안정할 수 있습니다.)
    * **[InMoov ROS (URDF/Description) GitHub](https://github.com/alansrobotlab/inmoov_ros)** (시뮬레이션을 위한 URDF 파일이 포함된 ROS 패키지)
    * **[MyRobotLab/InMoov2 GitHub](https://github.com/MyRobotLab/InMoov2)** (InMoov V2의 메인 소프트웨어 및 스크립트 리포지토리)
...
* **링크:**
    * **[ros-industrial-attic/robotiq GitHub](https://github.com/ros-industrial-attic/robotiq)** (ROS-Industrial에서 보관용(attic)으로 이동된 리포지토리)
...
* **링크:**
    * **[shadow-robot GitHub (조직 페이지)](https://github.com/shadow-robot)** (이 조직 페이지에서 `sr_common` 등 관련 리포지토리를 찾으실 수 있습니다.)
