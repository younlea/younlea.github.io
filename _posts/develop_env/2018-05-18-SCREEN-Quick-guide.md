---
title: "SCREEN Quick guide"
excerpt_separator: "<!--more-->"
date: 2018-05-18 13:49:34 +0900
categories:
  - develop_env
tags:
  - develop_env
...
ref : <http://aperiodic.net/screen/quick_reference>
...
The [man page](http://aperiodic.net/screen/man:start "man:start") is the complete reference.
...
| stuff characters into the input buffer using bash to expand a newline character | ``` screen -S <name> [-p <page>] -X stuff $'quit\r' ``` |
